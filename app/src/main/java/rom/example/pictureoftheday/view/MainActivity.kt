...
import rom.example.pictureoftheday.view.main.MainFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTheme(R.style.ToxicGreenTheme) //FIXME как-то криво добавил темы? Теперь без этой строчки приложение не работает. Почему? Думаю, что проблема в superColor.
